...
[![aur/votes](https://img.shields.io/aur/votes/zathura-language-server)](https://aur.archlinux.org/packages/zathura-language-server)
[![aur/popularity](https://img.shields.io/aur/popularity/zathura-language-server)](https://aur.archlinux.org/packages/zathura-language-server)
[![aur/maintainer](https://img.shields.io/aur/maintainer/zathura-language-server)](https://aur.archlinux.org/packages/zathura-language-server)
[![aur/last-modified](https://img.shields.io/aur/last-modified/zathura-language-server)](https://aur.archlinux.org/packages/zathura-language-server)
[![aur/version](https://img.shields.io/aur/version/zathura-language-server)](https://aur.archlinux.org/packages/zathura-language-server)
